...
export default function Vino({ data }) {
    const { title, description, precio } = data;
    return (
        <div className="card border-bottom-0 border-start-1 border-top-0 border-2 border-end-0 borde-marron px-2 px-sm-0 pe-sm-3 pe-lg-5">
